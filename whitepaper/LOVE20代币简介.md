...
6. 治理激励：为给能够体现和凝聚社群共识的行动投票，并对随机抽取到的地址，验证是否真实参与行动，获得治理激励铸造权。
7. 激励加速：治理激励由 50%是验证激励与 50%加速激励构成，需额外质押 LOVE20 代币以获得加速激励，一个地址的加速激励不超过验证激励的 2 倍。
8. 治理获得：为 LOVE20 代币提供并质押基于 TKM20 的流动性来获取治理票数，申请取回质押流动性时，承诺可以等待的时间约久，所获得的治理票数越多。
