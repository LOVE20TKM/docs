...
python3 "$validator" "$repo_root/ai/skills/love20-extension-dev"
python3 "$validator" "$repo_root/ai/skills/love20-frontend-bridge"
python3 "$validator" "$repo_root/ai/skills/love20-frontend-dev"
python3 "$validator" "$repo_root/ai/skills/love20-integration-dev"
...
python3 "$validator" "$repo_root/ai/skills/love20-test-and-release"
