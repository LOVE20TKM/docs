...
- Average must-cover score: 94%
- Output-shape pass rate: 25/25
...
| `extension-dev-new-token-join-flow` | PASS | hit | ok | 3/3 | pass | demo PASS case for extension token-join plan |
| `extension-dev-group-write-surface` | PASS | hit | ok | 3/3 | pass | demo PASS case for group extension write surface |
| `frontend-trace-token-stat-card` | PASS | hit | ok | 3/3 | pass | demo PASS case for frontend trace |
| `frontend-dev-new-extension-plugin` | PASS | hit | ok | 3/3 | pass | demo PASS case for frontend extension plugin wiring |
| `frontend-dev-new-write-page` | PASS | hit | ok | 3/3 | pass | demo PASS case for frontend write flow |
| `integration-dev-extension-end-to-end` | PASS | hit | ok | 3/3 | pass | demo PASS case for integration walkthrough |
| `integration-dev-viewer-and-log-sync` | PASS | hit | ok | 3/3 | pass | demo PASS case for integration read-path sync |
...
| `test-release-extension-change-matrix` | PASS | hit | ok | 3/3 | pass | demo PASS case for extension release matrix |
| `test-release-core-viewer-rollout` | PASS | hit | ok | 3/3 | pass | demo PASS case for core plus viewer rollout |
...
- Selected skills: `love20-tkm-contract-playbooks`
- Response file: `docs/ai/evals/runs/demo-three-states.case4.playbook-pass.md`
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-contract-playbooks/references/operation-playbooks.md`
  - ok: `docs/ai/skills/love20-tkm-contract-playbooks/references/prerequisites-and-timing.md`
  - ok: `docs/ai/skills/love20-tkm-contract-playbooks/references/cast-script-index.md`
...
- Selected skills: `love20-tkm-core-protocol`
...
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-core-protocol/references/protocol-overview.md`
  - ok: `core/src/interfaces/ILOVE20Launch.sol`
...
- Selected skills: `love20-tkm-extension-patterns`
- Response file: `docs/ai/evals/runs/demo-three-states.case7.extension-pass.md`
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-extension-patterns/references/extension-framework.md`
  - ok: `docs/ai/skills/love20-tkm-extension-patterns/references/extension-examples.md`
...
- Selected skills: `love20-tkm-extension-dev`
- Response file: `docs/ai/evals/runs/demo-walkthrough.extension-dev-new-token-join-flow.response.md`
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-extension-dev/references/dev-workflow.md`
  - ok: `docs/ai/skills/love20-tkm-extension-dev/references/contract-and-test-checklist.md`
...
- Manual notes: demo PASS case for extension token-join plan
...
- Selected skills: `love20-tkm-frontend-bridge`
- Response file: `docs/ai/evals/runs/demo-three-states.case10.frontend-pass.md`
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-frontend-bridge/references/frontend-map.md`
  - ok: `docs/ai/skills/love20-tkm-frontend-bridge/references/data-loading-map.md`
...
- Selected skills: `love20-tkm-frontend-dev`
- Response file: `docs/ai/evals/runs/demo-walkthrough.frontend-dev-new-extension-plugin.response.md`
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-frontend-dev/references/dev-workflow.md`
  - ok: `docs/ai/skills/love20-tkm-frontend-dev/references/read-write-and-registration.md`
...
- Selected skills: `love20-tkm-integration-dev`
- Response file: `docs/ai/evals/runs/demo-three-states.integration-dev-extension-end-to-end.response.md`
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-integration-dev/references/integration-workflow.md`
  - ok: `docs/ai/skills/love20-tkm-integration-dev/references/sync-points.md`
  - ok: `extension-lp/src/ExtensionLp.sol`
  - ok: `extension-lp/src/ExtensionLpFactory.sol`
  - ok: `extension-lp/script/network/thinkium70001_public/address.extension.lp.params`
...
- Selected skills: `love20-tkm-integration-dev`
- Response file: `docs/ai/evals/runs/demo-three-states.integration-dev-viewer-and-log-sync.response.md`
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-integration-dev/references/integration-workflow.md`
  - ok: `docs/ai/skills/love20-tkm-integration-dev/references/sync-points.md`
...
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-frontend-bridge/references/data-loading-map.md`
  - ok: `docs/ai/skills/love20-tkm-contract-playbooks/references/periphery-and-viewers.md`
...
- Selected skills: `love20-tkm-navigator`
- Response file: `docs/ai/evals/runs/demo-three-states.case1.pass.md`
- Cited files:
  - ok: `docs/whitepaper/LOVE20协议设计.md`
  - ok: `docs/ai/skills/love20-tkm-navigator/references/source-of-truth.md`
  - ok: `core/src/interfaces/ILOVE20Launch.sol`
...
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-navigator/references/repo-index.md`
...
- Selected skills: `love20-tkm-prompts`
- Response file: `docs/ai/evals/runs/demo-three-states.case9.prompt-pass.md`
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-prompts/references/prompt-selection.md`
  - ok: `docs/ai/skills/love20-tkm-prompts/references/interaction-state-and-debug-prompts.md`
  - ok: `docs/ai/skills/love20-tkm-state-and-events/SKILL.md`
  - ok: `docs/ai/skills/love20-tkm-frontend-bridge/SKILL.md`
...
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-prompts/references/prompt-selection.md`
  - ok: `docs/ai/skills/love20-tkm-prompts/references/interaction-state-and-debug-prompts.md`
  - ok: `docs/ai/skills/love20-tkm-prompts/references/protocol-and-architecture-prompts.md`
...
- Selected skills: `love20-tkm-test-and-release`
- Response file: `docs/ai/evals/runs/demo-three-states.test-release-extension-change-matrix.response.md`
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-test-and-release/references/test-matrix.md`
  - ok: `docs/ai/skills/love20-tkm-test-and-release/references/release-checklist.md`
  - ok: `extension-lp/test/ExtensionLp.t.sol`
  - ok: `extension-lp/test/integration/Flow.t.sol`
  - ok: `extension-lp/script/network/thinkium70001_public/address.extension.lp.params`
  - ok: `interface-test/src/config/extensionConfig.ts`
...
- Selected skills: `love20-tkm-test-and-release`
- Response file: `docs/ai/evals/runs/demo-three-states.test-release-core-viewer-rollout.response.md`
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-test-and-release/references/test-matrix.md`
  - ok: `docs/ai/skills/love20-tkm-test-and-release/references/release-checklist.md`
  ...
  - ok: `script/script/log/one_click_process.sh`
- Manual notes: demo PASS case for core plus viewer rollout

### Troubleshoot contribute-with-ETH invalid recipient failure

- `id`: `runbook-eth-contribute-invalid-recipient`
- Selected skills: `love20-tkm-runbooks`
- Response file: `docs/ai/evals/runs/demo-three-states.case8.runbook-pass.md`
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-runbooks/references/evidence-sources.md`
  - ok: `docs/ai/skills/love20-tkm-runbooks/references/launch-and-stake-runbooks.md`
...
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-runbooks/references/extensions-and-groups-runbooks.md`
...
- Selected skills: `love20-tkm-selectors-and-errors`
- Response file: `docs/ai/evals/runs/demo-three-states.case6.selector-pass.md`
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-selectors-and-errors/references/generated-error-selector-index.md`
  - ok: `docs/ai/skills/love20-tkm-selectors-and-errors/references/decoding-workflow.md`
...
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-selectors-and-errors/references/source-files.md`
  - ok: `interface-test/src/errors/contractErrorParser.ts`
  - ok: `interface-test/src/errors/unifiedErrorMap.ts`
...
- Selected skills: `love20-tkm-state-and-events`
- Response file: `docs/ai/evals/runs/demo-three-states.case5.state-pass.md`
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-state-and-events/references/entity-lookup-playbooks.md`
  - ok: `docs/ai/skills/love20-tkm-state-and-events/references/generated-state-event-index.md`
  - ok: `periphery/src/LOVE20RoundViewer.sol`
...
- Cited files:
  - ok: `docs/ai/skills/love20-tkm-state-and-events/references/event-and-indexing.md`
  - ok: `docs/ai/skills/love20-tkm-state-and-events/references/generated-state-event-index.md`
