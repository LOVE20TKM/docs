...
- Minimum sources:
  ...
  - `docs/ai/skills/love20-tkm-selectors-and-errors/SKILL.md`
- Fail if:
...
- Minimum sources:
  - `docs/ai/skills/love20-tkm-prompts/SKILL.md`
  - one domain skill such as `love20-tkm-contract-playbooks` or `love20-tkm-core-protocol`
- Fail if:
