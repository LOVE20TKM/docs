...
- add `$love20-tkm-runbooks` if the diff affects failure handling
...
- add `$love20-tkm-prompts` only if you want the output phrasing or prompt contract improved too
...
```text
Use $love20-tkm-prompts and the relevant LOVE20 domain skill.
...
```text
Use $love20-tkm-prompts and the relevant LOVE20 domain skills.
