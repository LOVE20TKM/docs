...
- add `$love20-tkm-extension-patterns` if the action uses extensions

Template:

```text
Use $love20-tkm-contract-playbooks <and $love20-tkm-extension-patterns if needed>.
...
- add `$love20-tkm-frontend-bridge` if the question is page-specific

Template:

```text
Use $love20-tkm-state-and-events <and $love20-tkm-frontend-bridge if needed>.
...
- `$love20-tkm-runbooks`
- add `$love20-tkm-selectors-and-errors` if there is a selector, topic, or raw revert

Template:

```text
Use $love20-tkm-runbooks <and $love20-tkm-selectors-and-errors if needed>.
