---
name: love20-tkm-frontend-bridge
...
- If the question becomes "what is the protocol truth" rather than "how does the UI load or send it", route to `docs/ai/skills/love20-tkm-state-and-events/SKILL.md` or `docs/ai/skills/love20-tkm-core-protocol/SKILL.md`.
