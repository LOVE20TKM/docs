...
4. If the symptom is only a raw selector or topic, switch to `love20-tkm-selectors-and-errors` before concluding.
5. If the symptom is only a page-data mismatch, switch to `love20-tkm-frontend-bridge` after you identify the failing read path.
