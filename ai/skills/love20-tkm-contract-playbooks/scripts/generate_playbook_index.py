...
def main() -> None:
    ...
    output_path = docs_root / "ai" / "skills" / "love20-tkm-contract-playbooks" / "references" / "generated-playbook-index.md"

    lines = [
        "# Generated Playbook Index",
        "",
        "This file is generated by `ai/skills/love20-tkm-contract-playbooks/scripts/generate_playbook_index.py`.",
