...
目前各种发射平台，虽然一般会采用"公平发射+全流通+烧毁 LP"模式，看起来公平，但却有着非常大的机制缺陷。
...
"烧毁 LP"模式虽然营造出稀缺性假象，但没真正解决流动性问题：
...
以 Aragon 为代表的 DAO 平台虽然具备基础治理功能，但其模式存在多重缺陷和瓶颈：
...
- **流动性是资产的基本要素**
  ...
  Web3 代币一般采取 DEX 去中心化交易，这种机制下，LP 池子的大小，决定了流动性的大小，所以提供为 LP 池添加 LP 就非常重要。添加 LP 池，可以看成社群成员需要承担的，“链上”的最大责任。
...
3. MEME 代币的创新升级
   LOVE20 虽不是继承或来源于 MEME，但是在公平发射和社群驱动方面存在相似性。 而 LOVE20 的机制弥补了 MEME 代币 的缺陷：通过可验证的共识行动铸币，并提供了基于 LP 的治理机制，有效促进了社群共识的建立，和代币长期价值的稳定。
...
因为每个周期的铸币释放量，是剩余待铸币数量的 1%，所以，越早期加入，红利就越大。这也是对早期参与者的激励。

## 7. 社群铸币发展的速度会是怎么样？

这取决于第一个成功案例的产生时间。

一旦产生了第一个成功案例，就会非常快地实现快速扩张。

LOVE20 协议和工具是完全开源的，任何社群都可以免费获取和部署。所有的经验和模式，其他社区可以快速复制。这也是去中心化和开源的力量。

## 8. 社群 KOL 在社群铸币过程中是不是很重要？

是的。

社群 KOL 是社群铸币最重要的推动者，也是核心治理者，大概率也是社群铸币的最大受益者。

让尽可能多的 社群 KOL 都加入到这场即将爆发的洪流中来吧！
